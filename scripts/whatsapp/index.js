...
function reserva(){
    ...
    window.location.href = `https://api.whatsapp.com/send?phone=558199701949&text=Local%20de%20reserva:%20${lugar.value}%0AData%20de%20check-in:%20${entrada}%0AData%20de%20checkout:%20${saida}%0AQuantidade%20de%20adultos:%20${adulto.value}%0AQuantidade%20de%20crian%C3%A7as:%20${crianca.value}`
}
...
function promocao(){
    ...
    alert('funcionann')
    window.location.href = `https://api.whatsapp.com/send?phone=558199701949&text=Nome:%20${nome.value}%0ATelefone:%20${telefone.value}%0AEmail:%20${email.value}`
}